...
This repository contains the official index of discovered IDA plugins, and provides the underlying data for https://plugins.hex-rays.com/ and the Plugin Manager. Please read [Blog: Introducing the IDA Plugin Manager](https://hex-rays.com/blog/introducing-the-ida-plugin-manager) for a detailed introduction.
...
Watch the Git history to see plugin and (hopefully unlikely) moderation events.
Commits like 3c0f21c6672c46ff3cbb071b86e5389bc64583cb are made by the indexer, and include a nice summary in the commit message:
...
2. check the indexer log report: https://hexrayssa.github.io/plugin-repository/logs/indexer.html
  ...
  b. Otherwise, open an issue or PR adding your repo to [./known-repositories.txt](./known-repositories.txt)
